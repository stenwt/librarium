...
import DeprecatedTag from "@site/src/shared/components/common/DeprecatedTag";
      ...
      {({ className, style, tokens, getLineProps, getTokenProps }) => {
        return (
          <pre className={className} style={style}>
            {tokens.map((line, i) => {
              const deprecatedLineIndex = line.findIndex((token) =>
                token.content.includes("deprecated")
              );
