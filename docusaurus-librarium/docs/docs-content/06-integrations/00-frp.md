...
<TabItem value="Palette Deployed" label="palette-deployed">
...
![frp-cert-san-example](/assets/docs/images/docs_integrations_frp_cert-san-example.png)
...
![TLS-SAN configuration example](/assets/docs/images/docs_integrations_frp_tls-san-example.png)

<br />


</TabItem>
<TabItem value="Imported Cluster" label="imported-cluster">
