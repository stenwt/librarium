...
description: "Learn more about the Palette eXtended Kubernetes pack and how you can use it with your host clusters."
hiddenFromNav: true
type: "integration"
category: ["kubernetes"]
...
<TabItem value="1.26.x" label="k8s_v1.26">
...
<TabItem value="1.25.x" label="k8s_v1.25">
...
<TabItem value="1.24.x" label="k8s_v1.24">
