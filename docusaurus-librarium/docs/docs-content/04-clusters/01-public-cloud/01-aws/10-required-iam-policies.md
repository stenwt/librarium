...
<TabItem value="Controllers Policy" label="Controllers Policy">
...
<TabItem value="Control Plane Policy" label="Control Plane Policy">
...
<TabItem value="Nodes Policy" label="Nodes Policy">
...
<TabItem value="Deployment Policy" label="Deployment Policy">
...
<Tabs>
<TabItem value="Minimum Dynamic Permissions" label="Minimum Dynamic Permissions">
...
<TabItem value="Minimum Static Permissions" label="Minimum Static Permissions">
