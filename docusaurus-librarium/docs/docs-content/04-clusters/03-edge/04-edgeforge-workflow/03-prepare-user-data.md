...
![The flow of an install process not requiring additional customization](/assets/docs/images/clusters_site-deployment_prepare-edge-configuration_install-flow.png)
...
![The flow of an install process with an additional customization occurring at the physical site. The additional customization is using a USB stick to upload the new user data.](/assets/docs/images/clusters_site-deployment_prepare-edge-configuration_install-flow-with-more-user-data.png)
