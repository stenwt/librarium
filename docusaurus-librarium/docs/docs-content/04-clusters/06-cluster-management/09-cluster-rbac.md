...
![A view of the cluster settings page when creating a cluster](/assets/docs/images/clusters_cluster-management_cluster-rbac_cluster-creation-settings.png)
...
![A view of the cluster settings page for an active cluster](/assets/docs/images/clusters_cluster-management_cluster-rbac_cluster-settings.png)
...
<Tabs>
<TabItem value="Assign a Cluster Role" label="clusterRoleBinding">
...
<TabItem value="Assign a Namespace Role" label="roleBinding">
...
![A subject of the type group is assigned as the subject in a RoleBinding](/assets/docs/images/clusters_cluster-management_cluster-rbac_cluster-subject-group.png)
