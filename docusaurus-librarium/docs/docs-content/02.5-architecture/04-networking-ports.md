...
![SaaS Network Diagram with ports](/assets/docs/images/architecture_networking-ports_saas-network-diagram.png "title=SaaS Network Diagram with ports")
...
![SaaS network diagram displaying the network paths for edge](/assets/docs/images/architecture_networking-ports_saas-network-diagram-edge.png)
...
![On-prem network diagram](/assets/docs/images/architecture_networking-ports_network-diagram.png "#title="network diagram")
