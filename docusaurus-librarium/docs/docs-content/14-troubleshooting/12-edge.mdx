...
title: "Edge"
metaTitle: "Edge"
metaDescription: "Troubleshooting steps for common Edge scenarios."
icon: ""
hideToC: false
fullWidth: false
---
...
## Override or Reconfigure Read-only File System Stage
...
![The grubmenu displays with the command rd.cos.debugrw typed in the terminal.](/assets/docs/images/troubleshooting_edge_grub-menu.png)
