...
![A view of the PDE dashboard with resources in use.](/assets/docs/images/docs_devx_pde-dashboard-utilization.png)
...
![A view of the Palette CLI menu from a terminal](/assets/docs/images/devx_devx_cli-display.png)
