...
![An architecture diagram outlining the five different install phases](/assets/docs/images/enterprise-version_air-gap-repo_overview-order-diagram.png)
...
<TabItem value="Palette Installer" label="palette-installer">
...
<TabItem value="Kubernetes Packages" label="k8s-packages">
...
<TabItem value="Kubeadm Packages" label="kubeadm-packages">
...
<TabItem value="Ubuntu 22.04 - K3s " label="ubuntu-22-k3s">
...
<TabItem value="Ubuntu 22.04 - RKE " label="ubuntu-22-rke">
...
<TabItem value="Ubuntu 22.04 - Kubeadm" label="ubuntu-22-kubeadm">
...
<TabItem value="Ubuntu 20.04 - K3s" label="ubuntu-20-k3s">
...
<TabItem value="Ubuntu 20.04 - RKE" label="ubuntu-20-rke">
...
<TabItem value="Ubuntu 20.04 - Kubeadm" label="ubuntu-20-kubeadm">
...
<TabItem value="OpenSuse - K3s" label="opensuse-k3s">
...
<TabItem value="OpenSuse - RKE" label="opensuse-rke">
...
<TabItem value="OpenSuse - Kubeadm" label="opensuse-kubeadm">
