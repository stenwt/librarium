...
<TabItem value="Profile Driven Storage" label="Profile Driven Storager">
...
<TabItem value="Storage views" label="Storage views">
...
<TabItem value="vSphere Tagging" label="vSphere Tagging">
