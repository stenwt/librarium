...
<TabItem value="Generic Kubernetes" label="generic-k8s">
...
7. From the cluster details page, click on **Compute** > **Node Group**. Next, click on **Node IAM role ARN link**. 
    ...
    ![A view of the cluster details page with the Node IAM role ARN highlighted](/assets/docs/images/enterprise-version_deploying-palette-with-helm_aws-iam-role.png)
