...
metaDescription: "Learn how to use the Spectro Cloud API through examples."
icon: ""
hideToC: true
fullWidth: false
hiddenFromNav: false
...
The payload for creating a host cluster can be lengthy due to the various configurations available for a host cluster. The payload is condensed in the following examples to improve readability and lack all the required values.
