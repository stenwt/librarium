...
<Tabs>
<TabItem value="PX Essentials" label="PX Essentials">
...
<TabItem value="PX Enterprise" label="PX Enterprise">
...
<TabItem value="PX Enterprise SaaS PAYG" label="PX Enterprise SaaS PAYG">
...
<TabItem value="VMware vSphere" label="VMware vSphere">
...
<TabItem value="Pure Flash Array" label="Pure Flash Array">
...
<Tabs>
<TabItem value="Use Internal Kvdb" label="Use Internal Kvdb">
...
<TabItem value="Use External Kvdb over HTTP" label="Use External Kvdb over HTTP">
...
<TabItem value="Use External Kvdb over SSL" label="Use External Kvdb over SSL">
