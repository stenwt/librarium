...
<Tooltip trigger={<u>UI</u>}>
The platform installer contains a web application called the{" "}
<a href="/enterprise-version/deploying-the-platform-installer/#monitorinstallation">
Supervisor
</a>
, to provide detailed progress of the installation.{" "}
</Tooltip>
