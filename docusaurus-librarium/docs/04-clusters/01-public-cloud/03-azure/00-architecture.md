...
![An Azure IaaS architecture diagram](/assets/docs/images/clusters_azure_architecture_iaas-overview.png)
...
![An Azure AKS architecture diagram](/assets/docs/images/clusters_azure_architecture_aks-diagram.png)
