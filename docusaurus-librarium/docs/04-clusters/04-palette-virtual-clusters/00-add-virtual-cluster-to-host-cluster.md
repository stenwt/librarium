...
<Tabs>
<TabItem value="Configure Load Balancer Endpoint" label="Configure Load Balancer Endpoint">
...
<TabItem value="Configure Ingress Endpoint" label="Configure Ingress Endpoint">
...
3. Create a wildcard DNS record that maps the Host Pattern to the NGINX Ingress Controller load balancer. The example shows an AWS Route53 record for the `*.starship.te.spectrocloud.com` Host DNS Pattern. 
  ...
  |-|-|
  |![AWS Route 53](/assets/docs/images/record-details.png) |Here is an example of an <br /> AWS Route53 record for the <br />`*.starship.te.spectrocloud.com` <br /> Host DNS Pattern.|
