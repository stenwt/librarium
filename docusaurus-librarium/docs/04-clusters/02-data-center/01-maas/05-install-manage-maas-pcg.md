...
![An architecture diagram of MaaS with PCG.](/assets/docs/images/clusters_maas_install-manage-mass-pcg_diagram-of-mass-with-pcg.png)
...
![Image showing external DNS server machines that MAAS deploys in addition to a DNS delegation](/assets/docs/images/clusters_maas_maas-dns-setup.png)
...
<TabItem value="Install PCG" label="install_pcg"> 
...
<TabItem value="Edit PCG Config" label="edit_pcg_config">
