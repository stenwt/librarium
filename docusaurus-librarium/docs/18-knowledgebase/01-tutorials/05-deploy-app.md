...
![Architecture diagram depicting two virtual clusters](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_architecture-diagram.png)
...
![Image with an arrow pointing to the user drop-down Menu](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_toggle-app-mode.png)
...
![View of the virtual cluster list](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_virtual-cluster-list.png)
...
Palette’s Dev Engine allows you to deploy up to two virtual clusters into the Beehive cluster group. Each virtual cluster requires a minimum of 4 CPU, 4 GiB memory, and 2 GiB storage. When using the Beehive cluster, you can allocate a maximum of 12 CPU, 16 Gib memory, and 20 GiB of storage. Check out the [Palette Dev Engine and Quotas](/devx/manage-dev-engine/resource-quota) documentation to learn more about limits.
...
![The App Profile page with arrows guiding](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_app-profiles.png)
...
![App Profile container creation page with details](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_app-profile-creation.png)
...
![Cluster details view displaying exposed services](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_cluster-details-view.png)
...
![Hello Universe landing page displaying global clicks](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_hello-universe.png)
...
![Postgres service creation page](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_postgres-service-create.png)
...
![A diagram of the reverse proxy architecture](/assets/docs/images/tutorials/deploy-app/devx_apps_deploys-apps_reverse-proxy-diagram.png)
...
![App deployment cluster-2](/assets/docs/images/tutorials/deploy-app/devx_app_deploy-apps_cluster-2-deploy-app.png)
...
![Cluster 2's details page](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_cluster-2-details-page.png)
...
![View of the self-hosted version of Hello Universe](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-app_self-hosted-hello-universe.png)
...
![Apps view with an arrow pointing towards the delete button](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_delete-apps-view.png)
...
![Delete a cluster view with arrow](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_delete-cluster-view.png)
...
![Image that points to the user drop-down Menu and points to the API key link](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-app_create-api-key.png)
...
![UI's ability to display the API object](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-apps_ui-api-display.png)
...
![scenario-1 overview page with an arrow pointing to the URL](/assets/docs/images/tutorials/deploy-app/devx_app_deploy-apps_scenario-1-overview.png)
...
![A diagram of the three-tier architecture where the load balancer forwards all requests to the UI container OR the API container](/assets/docs/images/tutorials/deploy-app/devx_apps_deploys-apps_reverse-proxy-diagram.png)
...
![A view of the scenario-2 overview page](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy_scenario-2-overview.png)
...
![View of the self-hosted hello universe app](/assets/docs/images/tutorials/deploy-app/devx_apps_deploy-app_self-hosted-hello-universe.png)
