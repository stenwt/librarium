...
<Tabs>
<TabItem value="Workload Visibility" label="Workload Visibility">
...
<TabItem value="Backups and Restore" label="Backups and Restore">
...
<TabItem value="Workspace Quota" label="Workspace Quota">
...
<TabItem value="Regex for Namespaces" label="Regex for Namespaces">
...
<TabItem value="Workspace Role Binding" label="Workspace Role Binding">
...
<TabItem value="Restricted Container Images" label="Restricted Container Images">
